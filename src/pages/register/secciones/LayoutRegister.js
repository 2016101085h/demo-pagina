                ...
                <div className="row align-items-center justify-content-center justify-content-lg-between">
                    <div className="col-lg-7 col-md-10">
                        <div className="header-hero-content">
                            ...
                            <h3 className="header-title wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.2s"><span>Registre </span> su cuenta</h3>
        ...
        <Button variant="contained" className='font-bold' style={{backgroundColor:"#dd493c"}} size="large" startIcon={<GoogleIcon></GoogleIcon>}>
          Google
                                ...
                                <div className="services-content">
                                    ...
                                    <p className="text mt-0">O Registre con tu correo electrónico</p>
                                    <br></br>
                                   
                                    <TextField id="filled-basic" fullWidth type='text' label="Apellidos y Nombres" variant="filled" />
                                  <br></br>
                                  <br></br>
                                  <TextField id="filled-basic" fullWidth type='email' label="Correo Electrónico" variant="filled" />
                                  <br></br>
                                  <br></br>
                                
                                   
                                   <TextField id="filled-basic" fullWidth type='email' label="Escriba una contraseña" variant="filled" />
                                 <br></br>
                                 <br></br>
                                 <TextField id="filled-basic" fullWidth type='password' label="Confirmar contrasaeña" variant="filled" />
                                
                                 <br></br>
                                 <br></br>
                                   <div>
                                   <FormGroup>
                                    <FormControlLabel control={<Checkbox defaultChecked />} label="Acepto térinos y condiciones" />
